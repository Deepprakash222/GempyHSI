...
import io
import contextlib
from Gempy_PSHD.code_hsi_label.model1 import MyModel
from Gempy_PSHD.code_hsi_label.map_func import compute_map
from Gempy_PSHD.code_hsi_label.initial_gempy_model import *
from Gempy_PSHD.code_hsi_label.final_gempy_model import *
...
def run_hsi_label(dataset, geo_model_init, geo_model_final):
    """
    ...
    directory_path = directory_path + "/" + dataset.name  + "_slope_gempy_" + str(slope_gempy)  + "likelihood_std_" + str(likelihood_std)
    ...
    Z_data = torch.tensor(normalised_data[:,2].numpy(), dtype=dtype, device=device)
